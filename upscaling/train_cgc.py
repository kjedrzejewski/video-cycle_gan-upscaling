from upscaler.data import load_images_from_dir, split_images_train_test
...
if __name__== "__main__":
    ...
    with open(loss_file_name, 'w+') as loss_file:
        loss_file.write('batch\tloss_1gen\tloss_2gen\tagg_loss\n')
