tvfrom upscaler.data import load_images_from_dir, split_images_train_test, downscale_images, crop_images_cgc
...
if __name__== "__main__":
    ...
    parser.add_argument('-gm', '--generator_model', action='store', dest='generator_model', default='inc-resnet', choices=['orig','skip-con','resnet-att','unetish','unetish-add', 'inc-resnet'], help='Generator model to be used')
    
    parser.add_argument('-dm', '--discriminator_model', action='store', dest='discriminator_model', default='sp512', choices=['s512', 'sp512'], help='Discriminator model to be used')
    ...
    parser.add_argument('-dl', '--discriminator_loss', action='store', dest='discriminator_loss', default='wass', choices=['wass'], help='Discriminator loss function to be used for the training')
    ...
    if model_prefix == 'auto':
        model_prefix = "gan2_" + values.generator_model + "_" + values.content_loss + "_" + values.discriminator_model + "_" + values.discriminator_loss + '_' + values.discriminator_activation + ("_x%d" % downscale_factor)
